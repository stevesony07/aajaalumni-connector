...
interface FeatureIconProps {
  className?: string;  // Add this interface to accept className prop
}
...
interface Feature {
  ...
  description: string;
  link: string;
  icon: React.FC<FeatureIconProps>;  // Update the icon type to include className
}
...
const features: Feature[] = [
  ...
  },
  {
    ...
    link: "/events",
    icon: ({ className }) => (
      <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/></svg>
    )
  },
  {
    ...
    link: "/features",
    icon: ({ className }) => (
      <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="7" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
    )
  },
  {
